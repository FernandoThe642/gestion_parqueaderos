...
a persistence unit "gestion_parqueaderosPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "gestion_parqueaderos/pom.xml":
...
artifact ("gestion_parqueaderos.war") is already built. You can build
